...
setInterval( function(){
  ...
  !paused? document.getElementById("Sara").innerHTML= "<p style= 'font-size: 15px; display: inline-block; '>" + contr( fe[himno] )[0][0] + " Palabras. " + "</br>" + contr( fe[himno] )[0][1] + " Caracteres (Sin espacios)." + "</p>" +  "<textarea spellcheck= 'false'>" + contr( fe[himno] )[1] + "</textarea>": 28918; !paused? himno < fe.length - 1? himno++: himno= 0: 1882; }, 5000); 
